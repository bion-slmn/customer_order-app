...
class CustomerView(APIView):
    ...
    def get(self, request: HttpRequest, customer_id: str) -> Response:
        ...
        customer_info = {'Customer_details': CustomerSerialiser(customer).data,
                         'orders': customer.orders.all().values('created_at', 'item', 'amount')}
    ...
    def put(self, request: HttpRequest, customer_id: str) -> Response:
        ...
        serialiser = CustomerSerialiser(customer, data=request.data, partial=True)
        if serialiser.is_valid():
            serialiser.save()
